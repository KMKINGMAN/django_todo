...
class TestTodoAPI:
    ...
    def test_todo_ordering(self, authenticated_client, user):
        ...
        todo1 = Todo.objects.create(title="First Todo", user=user)
        todo2 = Todo.objects.create(title="Second Todo", user=user)
        todo3 = Todo.objects.create(title="Third Todo", user=user)
